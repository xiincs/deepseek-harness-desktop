(()=>{var ys=(e,t,i)=>()=>{if(i)throw i[0];try{return e&&(t=e(e=0)),t}catch(s){throw i=[s],s}};var Ln=(e,t)=>()=>{try{return t||e((t={exports:{}}).exports,t),t.exports}catch(i){throw t=0,i}};function Tn(e){return e.replace(/\r?\n/g,"\r")}function An(e,t){return t?"\x1B[200~"+e+"\x1B[201~":e}function On(e,t){e.clipboardData&&e.clipboardData.setData("text/plain",t.selectionText),e.preventDefault()}function In(e,t,i,s){if(e.stopPropagation(),e.clipboardData){let r=e.clipboardData.getData("text/plain");Dr(r,t,i,s)}}function Dr(e,t,i,s){e=Tn(e),e=An(e,i.decPrivateModes.bracketedPasteMode&&s.rawOptions.ignoreBracketedPasteMode!==!0),i.triggerDataEvent(e,!0),t.value=""}function Br(e,t,i){let s=i.getBoundingClientRect(),r=e.clientX-s.left-10,n=e.clientY-s.top-10;t.style.width="20px",t.style.height="20px",t.style.left=`${r}px`,t.style.top=`${n}px`,t.style.zIndex="1000",t.focus()}function xs(e,t,i,s,r){Br(e,t,i),r&&s.rightClickSelect(e),t.value=s.selectionText,t.select()}function Ue(e){return e>65535?(e-=65536,String.fromCharCode((e>>10)+55296)+String.fromCharCode(e%1024+56320)):String.fromCharCode(e)}function ri(e,t=0,i=e.length){let s="";for(let r=t;r<i;++r){let n=e[r];n>65535?(n-=65536,s+=String.fromCharCode((n>>10)+55296)+String.fromCharCode(n%1024+56320)):s+=String.fromCharCode(n)}return s}function Wn(e){return e[Li]||[]}function se(e){if(_i.has(e))return _i.get(e);let t=function(i,s,r){if(arguments.length!==3)throw new Error("@IServiceName-decorator can only be used to decorate a parameter");zn(t,i,r)};return t._id=e,_i.set(e,t),t}function zn(e,t,i){t[Es]===t?t[Li].push({id:e,index:i}):(t[Li]=[{id:e,index:i}],t[Es]=t)}function Kn(e,t){if(confirm(`Do you want to navigate to ${t}?

WARNING: This link could potentially be dangerous`)){let i=window.open();if(i){try{i.opener=null}catch{}i.location.href=t}else console.warn("Opening link blocked as opener could not be cleared")}}function Wt(e){Yn(e)||Vn.onUnexpectedError(e)}function Yn(e){return e instanceof Xn?!0:e instanceof Error&&e.name===Pi&&e.message===Pi}function jn(e){return e?new Error(`Illegal argument: ${e}`):new Error("Illegal argument")}function Gn(e,t,i=0,s=e.length){let r=i,n=s;for(;r<n;){let o=Math.floor((r+n)/2);t(e[o])?r=o+1:n=o}return r-1}function ue(e,t=0){return e[e.length-(1+t)]}function Zn(e,t){return(i,s)=>t(e(i),e(s))}function eo(e,t){let i=Object.create(null);for(let s of e){let r=t(s),n=i[r];n||(n=i[r]=[]),n.push(s)}return i}function io(e,t){let i=this,s=!1,r;return function(){if(s)return r;if(s=!0,t)try{r=e.apply(i,arguments)}finally{t()}else r=e.apply(i,arguments);return r}}function no(e){Ze=e}function oi(e){return Ze?.trackDisposable(e),e}function hi(e){Ze?.markAsDisposed(e)}function kt(e,t){Ze?.setParent(e,t)}function oo(e,t){if(Ze)for(let i of e)Ze.setParent(i,t)}function Ms(e){return Ze?.markAsSingleton(e),e}function Qe(e){if(Fr.is(e)){let t=[];for(let i of e)if(i)try{i.dispose()}catch(s){t.push(s)}if(t.length===1)throw t[0];if(t.length>1)throw new AggregateError(t,"Encountered errors while disposing of store");return Array.isArray(e)?[]:e}else if(e)return e.dispose(),e}function ho(...e){let t=W(()=>Qe(e));return oo(e,t),t}function W(e){let t=oi({dispose:io(()=>{hi(t),e()})});return t}function bo(e,t,i){typeof t=="string"&&(t=e.matchMedia(t)),t.addEventListener("change",i)}function yo(e){return fs.INSTANCE.getZoomFactor(e)}function Co(){return Kt}function zo(e){if(e.charCode){let i=String.fromCharCode(e.charCode).toUpperCase();return en.fromString(i)}let t=e.keyCode;if(t===3)return 7;if($i)switch(t){case 59:return 85;case 60:if(Mo)return 97;break;case 61:return 86;case 107:return 109;case 109:return 111;case 173:return 88;case 224:if(Be)return 57;break}else if($t&&(Be&&t===93||!Be&&t===92))return 57;return No[t]||0}function qo(e){if(!e.parent||e.parent===e)return null;try{let t=e.location,i=e.parent.location;if(t.origin!=="null"&&i.origin!=="null"&&t.origin!==i.origin)return null}catch{return null}return e.parent}function Zo(e){return 55296<=e&&e<=56319}function Fs(e){return 56320<=e&&e<=57343}function Qo(e,t){return(e-55296<<10)+(t-56320)+65536}function eh(e){return ms(e,0)}function ms(e,t){switch(typeof e){case"object":return e===null?Te(349,t):Array.isArray(e)?ih(e,t):sh(e,t);case"string":return rn(e,t);case"boolean":return th(e,t);case"number":return Te(e,t);case"undefined":return Te(937,t);default:return Te(617,t)}}function Te(e,t){return(t<<5)-t+e|0}function th(e,t){return Te(e?433:863,t)}function rn(e,t){t=Te(149417,t);for(let i=0,s=e.length;i<s;i++)t=Te(e.charCodeAt(i),t);return t}function ih(e,t){return t=Te(104579,t),e.reduce((i,s)=>ms(s,i),t)}function sh(e,t){return t=Te(181387,t),Object.keys(e).sort().reduce((i,s)=>(i=rn(s,i),ms(e[s],i)),t)}function vi(e,t,i=32){let s=i-t,r=~((1<<s)-1);return(e<<t|(r&e)>>>s)>>>0}function $s(e,t=0,i=e.byteLength,s=0){for(let r=0;r<i;r++)e[t+r]=s}function rh(e,t,i="0"){for(;e.length<t;)e=i+e;return e}function lt(e,t=32){return e instanceof ArrayBuffer?Array.from(new Uint8Array(e)).map(i=>i.toString(16).padStart(2,"0")).join(""):rh((e>>>0).toString(16),t/4)}function B(e,t,i,s){return new hh(e,t,i,s)}function ah(e,t){return function(i){return t(new gt(e,i))}}function lh(e){return function(t){return e(new Ki(t))}}function _h(e){let t=e.getBoundingClientRect(),i=ye(e);return{left:t.left+i.scrollX,top:t.top+i.scrollY,width:t.width,height:t.height}}function on(e,t,i,...s){let r=uh.exec(t);if(!r)throw new Error("Bad use of emmet");let n=r[1]||"div",o;return e!=="http://www.w3.org/1999/xhtml"?o=document.createElementNS(e,n):o=document.createElement(n),r[3]&&(o.id=r[3]),r[4]&&(o.className=r[4].replace(/\./g," ").trim()),i&&Object.entries(i).forEach(([a,l])=>{typeof l>"u"||(/^on\w+$/.test(a)?o[a]=l:a==="selected"?l&&o.setAttribute(a,"true"):o.setAttribute(a,l))}),o.append(...s),o}function fh(e,t,...i){return on("http://www.w3.org/1999/xhtml",e,t,...i)}function _e(e){return typeof e=="number"?`${e}px`:e}function Ct(e){return new ph(e)}function gh(e,t,i){let s=null,r=null;if(typeof i.value=="function"?(s="value",r=i.value,r.length!==0&&console.warn("Memoize should only be used in functions with zero parameters")):typeof i.get=="function"&&(s="get",r=i.get),!r)throw new Error("not supported");let n=`$memoize$${t}`;i[s]=function(...o){return this.hasOwnProperty(n)||Object.defineProperty(this,n,{configurable:!1,enumerable:!1,writable:!1,value:r.apply(this,o)}),this[n]}}function Si(e,t){let i=t-e;return function(s){return e+i*Ch(s)}}function bh(e,t,i){return function(s){return s<i?e(s/i):t((s-i)/(1-i))}}function yh(e){return Math.pow(e,3)}function Ch(e){return 1-yh(1-e)}function Th(e){let t={lazyRender:typeof e.lazyRender<"u"?e.lazyRender:!1,className:typeof e.className<"u"?e.className:"",useShadows:typeof e.useShadows<"u"?e.useShadows:!0,handleMouseWheel:typeof e.handleMouseWheel<"u"?e.handleMouseWheel:!0,flipAxes:typeof e.flipAxes<"u"?e.flipAxes:!1,consumeMouseWheelIfScrollbarIsNeeded:typeof e.consumeMouseWheelIfScrollbarIsNeeded<"u"?e.consumeMouseWheelIfScrollbarIsNeeded:!1,alwaysConsumeMouseWheel:typeof e.alwaysConsumeMouseWheel<"u"?e.alwaysConsumeMouseWheel:!1,scrollYToX:typeof e.scrollYToX<"u"?e.scrollYToX:!1,mouseWheelScrollSensitivity:typeof e.mouseWheelScrollSensitivity<"u"?e.mouseWheelScrollSensitivity:1,fastScrollSensitivity:typeof e.fastScrollSensitivity<"u"?e.fastScrollSensitivity:5,scrollPredominantAxis:typeof e.scrollPredominantAxis<"u"?e.scrollPredominantAxis:!0,mouseWheelSmoothScroll:typeof e.mouseWheelSmoothScroll<"u"?e.mouseWheelSmoothScroll:!0,arrowSize:typeof e.arrowSize<"u"?e.arrowSize:11,listenOnDomNode:typeof e.listenOnDomNode<"u"?e.listenOnDomNode:null,horizontal:typeof e.horizontal<"u"?e.horizontal:1,horizontalScrollbarSize:typeof e.horizontalScrollbarSize<"u"?e.horizontalScrollbarSize:10,horizontalSliderSize:typeof e.horizontalSliderSize<"u"?e.horizontalSliderSize:0,horizontalHasArrows:typeof e.horizontalHasArrows<"u"?e.horizontalHasArrows:!1,vertical:typeof e.vertical<"u"?e.vertical:1,verticalScrollbarSize:typeof e.verticalScrollbarSize<"u"?e.verticalScrollbarSize:10,verticalHasArrows:typeof e.verticalHasArrows<"u"?e.verticalHasArrows:!1,verticalSliderSize:typeof e.verticalSliderSize<"u"?e.verticalSliderSize:0,scrollByPage:typeof e.scrollByPage<"u"?e.scrollByPage:!1};return t.horizontalSliderSize=typeof e.horizontalSliderSize<"u"?e.horizontalSliderSize:t.horizontalScrollbarSize,t.verticalSliderSize=typeof e.verticalSliderSize<"u"?e.verticalSliderSize:t.verticalScrollbarSize,Be&&(t.className+=" mac"),t}function Xe(e){let t=e.toString(16);return t.length<2?"0"+t:t}function Me(e,t){return e<t?(t+.05)/(e+.05):(e+.05)/(t+.05)}function Ih(e){return 57508<=e&&e<=57558}function Nh(e){return 9472<=e&&e<=9631}function Hh(e){return Ih(e)||Nh(e)}function Wh(){return{css:{canvas:Ot(),cell:Ot()},device:{canvas:Ot(),cell:Ot(),char:{width:0,height:0,left:0,top:0}}}}function Ot(){return{width:0,height:0}}function Zs(e,t,i){for(;e.length<i;)e=t+e;return e}function $h(){return new Fh}function ws(e,t,i){let s=i.getBoundingClientRect(),r=e.getComputedStyle(i),n=parseInt(r.getPropertyValue("padding-left")),o=parseInt(r.getPropertyValue("padding-top"));return[t.clientX-s.left-n,t.clientY-s.top-o]}function jh(e,t,i,s,r,n,o,a,l){if(!n)return;let h=ws(e,t,i);if(h)return h[0]=Math.ceil((h[0]+(l?o/2:0))/o),h[1]=Math.ceil(h[1]/a),h[0]=Math.min(Math.max(h[0],1),s+(l?1:0)),h[1]=Math.min(Math.max(h[1],1),r),h}function Zh(){if(!fn)return 0;let e=Lt.match(/Version\/(\d+)/);return e===null||e.length<2?0:parseInt(e[1])}function na(e,t,i,s){let r=i.buffer.x,n=i.buffer.y;if(!i.buffer.hasScrollback)return aa(r,n,e,t,i,s)+li(n,t,i,s)+la(r,n,e,t,i,s);let o;if(n===t)return o=r>e?"D":"C",Et(Math.abs(r-e),xt(o,s));o=n>t?"D":"C";let a=Math.abs(n-t),l=ha(n>t?e:r,i)+(a-1)*i.cols+1+oa(n>t?r:e,i);return Et(l,xt(o,s))}function oa(e,t){return e-1}function ha(e,t){return t.cols-e}function aa(e,t,i,s,r,n){return li(t,s,r,n).length===0?"":Et(Sn(e,t,e,t-et(t,r),!1,r).length,xt("D",n))}function li(e,t,i,s){let r=e-et(e,i),n=t-et(t,i),o=Math.abs(r-n)-ca(e,t,i);return Et(o,xt(mn(e,t),s))}function la(e,t,i,s,r,n){let o;li(t,s,r,n).length>0?o=s-et(s,r):o=t;let a=s,l=da(e,t,i,s,r,n);return Et(Sn(e,o,i,a,l==="C",r).length,xt(l,n))}function ca(e,t,i){let s=0,r=e-et(e,i),n=t-et(t,i);for(let o=0;o<Math.abs(r-n);o++){let a=mn(e,t)==="A"?-1:1;i.buffer.lines.get(r+a*o)?.isWrapped&&s++}return s}function et(e,t){let i=0,s=t.buffer.lines.get(e),r=s?.isWrapped;for(;r&&e>=0&&e<t.rows;)i++,s=t.buffer.lines.get(--e),r=s?.isWrapped;return i}function da(e,t,i,s,r,n){let o;return li(i,s,r,n).length>0?o=s-et(s,r):o=t,e<i&&o<=s||e>=i&&o<s?"C":"D"}function mn(e,t){return e>t?"A":"B"}function Sn(e,t,i,s,r,n){let o=e,a=t,l="";for(;(o!==i||a!==s)&&a>=0&&a<n.buffer.lines.length;)o+=r?1:-1,r&&o>n.cols-1?(l+=n.buffer.translateBufferLineToString(a,!1,e,o),o=0,e=0,a++):!r&&o<0&&(l+=n.buffer.translateBufferLineToString(a,!1,0,e+1),o=n.cols-1,e=o,a--);return l+n.buffer.translateBufferLineToString(a,!1,e,o)}function xt(e,t){let i=t?"O":"[";return g.ESC+i+e}function Et(e,t){e=Math.floor(e);let i="";for(let s=0;s<e;s++)i+=t;return i}function er(e,t){if(e.start.y>e.end.y)throw new Error(`Buffer range end (${e.end.x}, ${e.end.y}) cannot be before start (${e.start.x}, ${e.start.y})`);return t*(e.end.y-e.start.y)+(e.end.x-e.start.x+1)}function N(e,t){if(e!==void 0)try{return K.toColor(e)}catch{}return t}function ka(e,t,i,s,r,n){let o=[];for(let a=0;a<e.length-1;a++){let l=a,h=e.get(++l);if(!h.isWrapped)continue;let d=[e.get(a)];for(;l<e.length&&h.isWrapped;)d.push(h),h=e.get(++l);if(!n&&s>=a&&s<l){a+=d.length-1;continue}let c=0,u=Dt(d,c,t),f=1,_=0;for(;f<d.length;){let C=Dt(d,f,t),D=C-_,I=i-u,M=Math.min(D,I);d[c].copyCellsFrom(d[f],_,u,M,!1),u+=M,u===i&&(c++,u=0),_+=M,_===C&&(f++,_=0),u===0&&c!==0&&d[c-1].getWidth(i-1)===2&&(d[c].copyCellsFrom(d[c-1],i-1,u++,1,!1),d[c-1].setCell(i-1,r))}d[c].replaceCells(u,i,r);let p=0;for(let C=d.length-1;C>0&&(C>c||d[C].getTrimmedLength()===0);C--)p++;p>0&&(o.push(a+d.length-p),o.push(p)),a+=d.length-1}return o}function xa(e,t){let i=[],s=0,r=t[s],n=0;for(let o=0;o<e.length;o++)if(r===o){let a=t[++s];e.onDeleteEmitter.fire({index:o-n,amount:a}),o+=a-1,n+=a,r=t[++s]}else i.push(o);return{layout:i,countRemoved:n}}function Ea(e,t){let i=[];for(let s=0;s<t.length;s++)i.push(e.get(t[s]));for(let s=0;s<i.length;s++)e.set(s,i[s]);e.length=t.length}function Da(e,t,i){let s=[],r=e.map((l,h)=>Dt(e,h,t)).reduce((l,h)=>l+h),n=0,o=0,a=0;for(;a<r;){if(r-a<i){s.push(r-a);break}n+=i;let l=Dt(e,o,t);n>l&&(n-=l,o++);let h=e[o].getWidth(n-1)===2;h&&n--;let d=h?i-1:i;s.push(d),a+=d}return s}function Dt(e,t,i){if(t===e.length-1)return e[t].getTrimmedLength();let s=!e[t].hasContent(i-1)&&e[t].getWidth(i-1)===1,r=e[t+1].getWidth(0)===2;return s&&r?i-1:i}function Pa(e){return e==="block"||e==="underline"||e==="bar"}function wt(e,t=5){if(typeof e!="object")return e;let i=Array.isArray(e)?[]:{};for(let s in e)i[s]=t<=1?e[s]:e[s]&&wt(e[s],t-1);return i}function Ci(e,t){let i=(e.ctrl?16:0)|(e.shift?4:0)|(e.alt?8:0);return e.button===4?(i|=64,i|=e.action):(i|=e.button&3,e.button&4&&(i|=64),e.button&8&&(i|=128),e.action===32?i|=32:e.action===0&&!t&&(i|=3)),i}function Aa(e,t){let i=0,s=t.length-1,r;if(e<t[0][0]||e>t[s][1])return!1;for(;s>=i;)if(r=i+s>>1,e>t[r][1])i=r+1;else if(e<t[r][0])s=r-1;else return!0;return!1}function _r(e){let t=e.buffer.lines.get(e.buffer.ybase+e.buffer.y-1)?.get(e.cols-1),i=e.buffer.lines.get(e.buffer.ybase+e.buffer.y);i&&t&&(i.isWrapped=t[3]!==0&&t[3]!==32)}function fr(e){if(!e)return;let t=e.toLowerCase();if(t.indexOf("rgb:")===0){t=t.slice(4);let i=Ka.exec(t);if(i){let s=i[1]?15:i[4]?255:i[7]?4095:65535;return[Math.round(parseInt(i[1]||i[4]||i[7]||i[10],16)/s*255),Math.round(parseInt(i[2]||i[5]||i[8]||i[11],16)/s*255),Math.round(parseInt(i[3]||i[6]||i[9]||i[12],16)/s*255)]}}else if(t.indexOf("#")===0&&(t=t.slice(1),Ua.exec(t)&&[3,6,9,12].includes(t.length))){let i=t.length/3,s=[0,0,0];for(let r=0;r<3;++r){let n=parseInt(t.slice(i*r,i*r+i),16);s[r]=i===1?n<<4:i===2?n:i===3?n>>4:n>>8}return s}}function Ei(e,t){let i=e.toString(16),s=i.length<2?"0"+i:i;switch(t){case 4:return i[0];case 8:return s;case 12:return(s+s).slice(0,3);default:return s+s}}function qa(e,t=16){let[i,s,r]=e;return`rgb:${Ei(i,t)}/${Ei(s,t)}/${Ei(r,t)}`}function gr(e,t){if(e>24)return t.setWinLines||!1;switch(e){case 1:return!!t.restoreWin;case 2:return!!t.minimizeWin;case 3:return!!t.setWinPosition;case 4:return!!t.setWinSizePixels;case 5:return!!t.raiseWin;case 6:return!!t.lowerWin;case 7:return!!t.refreshWin;case 8:return!!t.setWinSizeChars;case 9:return!!t.maximizeWin;case 10:return!!t.fullscreenWin;case 11:return!!t.getWinState;case 13:return!!t.getWinPosition;case 14:return!!t.getWinSizePixels;case 15:return!!t.getScreenSizePixels;case 16:return!!t.getCellSizePixels;case 18:return!!t.getWinSizeChars;case 19:return!!t.getScreenSizeChars;case 20:return!!t.getIconTitle;case 21:return!!t.getWinTitle;case 22:return!!t.pushTitle;case 23:return!!t.popTitle;case 24:return!!t.setWinLines}return!1}function Sr(e){return 0<=e&&e<256}function Qa(e,t,i,s){let r={type:0,cancel:!1,key:void 0},n=(e.shiftKey?1:0)|(e.altKey?2:0)|(e.ctrlKey?4:0)|(e.metaKey?8:0);switch(e.keyCode){case 0:e.key==="UIKeyInputUpArrow"?t?r.key=g.ESC+"OA":r.key=g.ESC+"[A":e.key==="UIKeyInputLeftArrow"?t?r.key=g.ESC+"OD":r.key=g.ESC+"[D":e.key==="UIKeyInputRightArrow"?t?r.key=g.ESC+"OC":r.key=g.ESC+"[C":e.key==="UIKeyInputDownArrow"&&(t?r.key=g.ESC+"OB":r.key=g.ESC+"[B");break;case 8:r.key=e.ctrlKey?"\b":g.DEL,e.altKey&&(r.key=g.ESC+r.key);break;case 9:if(e.shiftKey){r.key=g.ESC+"[Z";break}r.key=g.HT,r.cancel=!0;break;case 13:r.key=e.altKey?g.ESC+g.CR:g.CR,r.cancel=!0;break;case 27:r.key=g.ESC,e.altKey&&(r.key=g.ESC+g.ESC),r.cancel=!0;break;case 37:if(e.metaKey)break;n?r.key=g.ESC+"[1;"+(n+1)+"D":t?r.key=g.ESC+"OD":r.key=g.ESC+"[D";break;case 39:if(e.metaKey)break;n?r.key=g.ESC+"[1;"+(n+1)+"C":t?r.key=g.ESC+"OC":r.key=g.ESC+"[C";break;case 38:if(e.metaKey)break;n?r.key=g.ESC+"[1;"+(n+1)+"A":t?r.key=g.ESC+"OA":r.key=g.ESC+"[A";break;case 40:if(e.metaKey)break;n?r.key=g.ESC+"[1;"+(n+1)+"B":t?r.key=g.ESC+"OB":r.key=g.ESC+"[B";break;case 45:!e.shiftKey&&!e.ctrlKey&&(r.key=g.ESC+"[2~");break;case 46:n?r.key=g.ESC+"[3;"+(n+1)+"~":r.key=g.ESC+"[3~";break;case 36:n?r.key=g.ESC+"[1;"+(n+1)+"H":t?r.key=g.ESC+"OH":r.key=g.ESC+"[H";break;case 35:n?r.key=g.ESC+"[1;"+(n+1)+"F":t?r.key=g.ESC+"OF":r.key=g.ESC+"[F";break;case 33:e.shiftKey?r.type=2:e.ctrlKey?r.key=g.ESC+"[5;"+(n+1)+"~":r.key=g.ESC+"[5~";break;case 34:e.shiftKey?r.type=3:e.ctrlKey?r.key=g.ESC+"[6;"+(n+1)+"~":r.key=g.ESC+"[6~";break;case 112:n?r.key=g.ESC+"[1;"+(n+1)+"P":r.key=g.ESC+"OP";break;case 113:n?r.key=g.ESC+"[1;"+(n+1)+"Q":r.key=g.ESC+"OQ";break;case 114:n?r.key=g.ESC+"[1;"+(n+1)+"R":r.key=g.ESC+"OR";break;case 115:n?r.key=g.ESC+"[1;"+(n+1)+"S":r.key=g.ESC+"OS";break;case 116:n?r.key=g.ESC+"[15;"+(n+1)+"~":r.key=g.ESC+"[15~";break;case 117:n?r.key=g.ESC+"[17;"+(n+1)+"~":r.key=g.ESC+"[17~";break;case 118:n?r.key=g.ESC+"[18;"+(n+1)+"~":r.key=g.ESC+"[18~";break;case 119:n?r.key=g.ESC+"[19;"+(n+1)+"~":r.key=g.ESC+"[19~";break;case 120:n?r.key=g.ESC+"[20;"+(n+1)+"~":r.key=g.ESC+"[20~";break;case 121:n?r.key=g.ESC+"[21;"+(n+1)+"~":r.key=g.ESC+"[21~";break;case 122:n?r.key=g.ESC+"[23;"+(n+1)+"~":r.key=g.ESC+"[23~";break;case 123:n?r.key=g.ESC+"[24;"+(n+1)+"~":r.key=g.ESC+"[24~";break;default:if(e.ctrlKey&&!e.shiftKey&&!e.altKey&&!e.metaKey)e.keyCode>=65&&e.keyCode<=90?r.key=String.fromCharCode(e.keyCode-64):e.keyCode===32?r.key=g.NUL:e.keyCode>=51&&e.keyCode<=55?r.key=String.fromCharCode(e.keyCode-51+27):e.keyCode===56?r.key=g.DEL:e.keyCode===219?r.key=g.ESC:e.keyCode===220?r.key=g.FS:e.keyCode===221&&(r.key=g.GS);else if((!i||s)&&e.altKey&&!e.metaKey){let o=Za[e.keyCode]?.[e.shiftKey?1:0];if(o)r.key=g.ESC+o;else if(e.keyCode>=65&&e.keyCode<=90){let a=e.ctrlKey?e.keyCode-64:e.keyCode+32,l=String.fromCharCode(a);e.shiftKey&&(l=l.toUpperCase()),r.key=g.ESC+l}else if(e.keyCode===32)r.key=g.ESC+(e.ctrlKey?g.NUL:" ");else if(e.key==="Dead"&&e.code.startsWith("Key")){let a=e.code.slice(3,4);e.shiftKey||(a=a.toLowerCase()),r.key=g.ESC+a,r.cancel=!0}}else i&&!e.altKey&&!e.ctrlKey&&!e.shiftKey&&e.metaKey?e.keyCode===65&&(r.type=1):e.key&&!e.ctrlKey&&!e.altKey&&!e.metaKey&&e.keyCode>=48&&e.key.length===1?r.key=e.key:e.key&&e.ctrlKey&&(e.key==="_"&&(r.key=g.US),e.key==="@"&&(r.key=g.NUL));break}return r}function nl(e,t){return e.text===t.text&&e.range.start.x===t.range.start.x&&e.range.start.y===t.range.start.y&&e.range.end.x===t.range.end.x&&e.range.end.y===t.range.end.y}function hl(e){return e.keyCode===16||e.keyCode===17||e.keyCode===18}var Er,Mn,Pn,q,y,Cs,Bi,ks,Ri,Nn,Hn,Rr,qe,Bt,jt,we,Es,Li,_i,ce,Tr,tt,Fn,_s,Ar,de,Or,$n,Rt,Mi,ni,Oe,us,Ie,Un,Ir,nt,Nr,qn,Vn,Pi,Xn,Ds,Ai,Jn,zr,Qn,Bs,Rs,Ls,ml,to,Fr,so,Ze,ro,Kr,Ve,R,rt,ge,Ii,$,Ps,ao,lo,co,Ts,_o,oe,Hi,uo,As,Vr,fo,zi,po,go,vo,zt,mo,So,Ft,v,wo,Fi,fs,wl,bl,ot,$i,$t,ps,jr,yl,Cl,Kt,st,Gt,Jt,yt,ko,Gr,Jr,xo,Eo,Do,Bo,At,Ut,Os,Ro,Pe,Ae,pe,Zr,Lo,ui,Qr,Be,Mo,fi,Po,kl,Re,ze,To,Ao,Oo,Io,xl,El,Dl,Bl,Fe,Rl,gs,pi,Is,Ns,No,en,Ho,Wo,Fo,$o,Ko,Uo,Ki,Hs,Vo,gt,Ws,sn,Yo,Xo,vs,jo,Go,gi,Jo,zs,nh,Ll,ye,Ml,Pl,Tl,Ks,Al,Ol,oh,Il,Nl,hh,Us,ch,Zt,dh,mi,qs,Hl,Q,uh,ph,hn,De,vt,vh,Ss,Vs,mh,Sh,wh,Ys,Xs,kh,xh,an,ln,Eh,Dh,Bh,js,Gs,Rh,Yi,Lh,Mh,Ph,Xi,ji,Ah,xe,$e,ct,Qt,g,Vt,cn,Gi,ee,te,ie,U,Js,X,H,K,le,Yt,Oh,ei,Ji,zh,Fh,wi,ve,It,Qs,dt,Nt,Kh,Zi,Qi,dn,Uh,qh,Vh,Yh,Xh,es,Gh,_n,ai,Lt,Mt,un,Jh,fn,ti,Qh,ea,pn,bs,gn,vn,ta,ia,ii,sa,ts,ra,_a,bi,ua,fa,pa,ga,va,is,tr,ir,j,je,mt,sr,rr,_t,ma,ss,Sa,wa,ba,ya,rs,Ca,nr,L,Y,Ht,yi,St,bn,Ba,J,Ge,or,hr,Ra,Cn,kn,ns,it,La,Ma,ar,lr,os,cr,ki,dr,hs,xi,Ta,G,Oa,Je,Ia,ut,Na,xn,ft,Ha,fe,pt,Wa,bt,ur,za,Se,Fa,$a,Ka,Ua,Va,Ke,pr,vr,mr,Ya,ls,Xa,wr,ja,Ga,cs,br,Ja,Za,V,el,Di,yr,tl,il,sl,rl,Cr,kr,si,ds,ol,al,ll,xr,cl,dl,_l,ul,Ee,En,Dn=ys(()=>{Er=Object.defineProperty,Mn=Object.getOwnPropertyDescriptor,Pn=(e,t)=>{for(var i in t)Er(e,i,{get:t[i],enumerable:!0})},q=(e,t,i,s)=>{for(var r=s>1?void 0:s?Mn(t,i):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&Er(t,i,r),r},y=(e,t)=>(i,s)=>t(i,s,e),Cs="Terminal input",Bi={get:()=>Cs,set:e=>Cs=e},ks="Too much output to announce, navigate to rows manually to read",Ri={get:()=>ks,set:e=>ks=e};Nn=class{constructor(){this._interim=0}clear(){this._interim=0}decode(e,t){let i=e.length;if(!i)return 0;let s=0,r=0;if(this._interim){let n=e.charCodeAt(r++);56320<=n&&n<=57343?t[s++]=(this._interim-55296)*1024+n-56320+65536:(t[s++]=this._interim,t[s++]=n),this._interim=0}for(let n=r;n<i;++n){let o=e.charCodeAt(n);if(55296<=o&&o<=56319){if(++n>=i)return this._interim=o,s;let a=e.charCodeAt(n);56320<=a&&a<=57343?t[s++]=(o-55296)*1024+a-56320+65536:(t[s++]=o,t[s++]=a);continue}o!==65279&&(t[s++]=o)}return s}},Hn=class{constructor(){this.interim=new Uint8Array(3)}clear(){this.interim.fill(0)}decode(e,t){let i=e.length;if(!i)return 0;let s=0,r,n,o,a,l=0,h=0;if(this.interim[0]){let u=!1,f=this.interim[0];f&=(f&224)===192?31:(f&240)===224?15:7;let _=0,p;for(;(p=this.interim[++_]&63)&&_<4;)f<<=6,f|=p;let C=(this.interim[0]&224)===192?2:(this.interim[0]&240)===224?3:4,D=C-_;for(;h<D;){if(h>=i)return 0;if(p=e[h++],(p&192)!==128){h--,u=!0;break}else this.interim[_++]=p,f<<=6,f|=p&63}u||(C===2?f<128?h--:t[s++]=f:C===3?f<2048||f>=55296&&f<=57343||f===65279||(t[s++]=f):f<65536||f>1114111||(t[s++]=f)),this.interim.fill(0)}let d=i-4,c=h;for(;c<i;){for(;c<d&&!((r=e[c])&128)&&!((n=e[c+1])&128)&&!((o=e[c+2])&128)&&!((a=e[c+3])&128);)t[s++]=r,t[s++]=n,t[s++]=o,t[s++]=a,c+=4;if(r=e[c++],r<128)t[s++]=r;else if((r&224)===192){if(c>=i)return this.interim[0]=r,s;if(n=e[c++],(n&192)!==128){c--;continue}if(l=(r&31)<<6|n&63,l<128){c--;continue}t[s++]=l}else if((r&240)===224){if(c>=i)return this.interim[0]=r,s;if(n=e[c++],(n&192)!==128){c--;continue}if(c>=i)return this.interim[0]=r,this.interim[1]=n,s;if(o=e[c++],(o&192)!==128){c--;continue}if(l=(r&15)<<12|(n&63)<<6|o&63,l<2048||l>=55296&&l<=57343||l===65279)continue;t[s++]=l}else if((r&248)===240){if(c>=i)return this.interim[0]=r,s;if(n=e[c++],(n&192)!==128){c--;continue}if(c>=i)return this.interim[0]=r,this.interim[1]=n,s;if(o=e[c++],(o&192)!==128){c--;continue}if(c>=i)return this.interim[0]=r,this.interim[1]=n,this.interim[2]=o,s;if(a=e[c++],(a&192)!==128){c--;continue}if(l=(r&7)<<18|(n&63)<<12|(o&63)<<6|a&63,l<65536||l>1114111)continue;t[s++]=l}}return s}},Rr="",qe=" ",Bt=class Lr{constructor(){this.fg=0,this.bg=0,this.extended=new jt}static toColorRGB(t){return[t>>>16&255,t>>>8&255,t&255]}static fromColorRGB(t){return(t[0]&255)<<16|(t[1]&255)<<8|t[2]&255}clone(){let t=new Lr;return t.fg=this.fg,t.bg=this.bg,t.extended=this.extended.clone(),t}isInverse(){return this.fg&67108864}isBold(){return this.fg&134217728}isUnderline(){return this.hasExtendedAttrs()&&this.extended.underlineStyle!==0?1:this.fg&268435456}isBlink(){return this.fg&536870912}isInvisible(){return this.fg&1073741824}isItalic(){return this.bg&67108864}isDim(){return this.bg&134217728}isStrikethrough(){return this.fg&2147483648}isProtected(){return this.bg&536870912}isOverline(){return this.bg&1073741824}getFgColorMode(){return this.fg&50331648}getBgColorMode(){return this.bg&50331648}isFgRGB(){return(this.fg&50331648)===50331648}isBgRGB(){return(this.bg&50331648)===50331648}isFgPalette(){return(this.fg&50331648)===16777216||(this.fg&50331648)===33554432}isBgPalette(){return(this.bg&50331648)===16777216||(this.bg&50331648)===33554432}isFgDefault(){return(this.fg&50331648)===0}isBgDefault(){return(this.bg&50331648)===0}isAttributeDefault(){return this.fg===0&&this.bg===0}getFgColor(){switch(this.fg&50331648){case 16777216:case 33554432:return this.fg&255;case 50331648:return this.fg&16777215;default:return-1}}getBgColor(){switch(this.bg&50331648){case 16777216:case 33554432:return this.bg&255;case 50331648:return this.bg&16777215;default:return-1}}hasExtendedAttrs(){return this.bg&268435456}updateExtended(){this.extended.isEmpty()?this.bg&=-268435457:this.bg|=268435456}getUnderlineColor(){if(this.bg&268435456&&~this.extended.underlineColor)switch(this.extended.underlineColor&50331648){case 16777216:case 33554432:return this.extended.underlineColor&255;case 50331648:return this.extended.underlineColor&16777215;default:return this.getFgColor()}return this.getFgColor()}getUnderlineColorMode(){return this.bg&268435456&&~this.extended.underlineColor?this.extended.underlineColor&50331648:this.getFgColorMode()}isUnderlineColorRGB(){return this.bg&268435456&&~this.extended.underlineColor?(this.extended.underlineColor&50331648)===50331648:this.isFgRGB()}isUnderlineColorPalette(){return this.bg&268435456&&~this.extended.underlineColor?(this.extended.underlineColor&50331648)===16777216||(this.extended.underlineColor&50331648)===33554432:this.isFgPalette()}isUnderlineColorDefault(){return this.bg&268435456&&~this.extended.underlineColor?(this.extended.underlineColor&50331648)===0:this.isFgDefault()}getUnderlineStyle(){return this.fg&268435456?this.bg&268435456?this.extended.underlineStyle:1:0}getUnderlineVariantOffset(){return this.extended.underlineVariantOffset}},jt=class Mr{constructor(t=0,i=0){this._ext=0,this._urlId=0,this._ext=t,this._urlId=i}get ext(){return this._urlId?this._ext&-469762049|this.underlineStyle<<26:this._ext}set ext(t){this._ext=t}get underlineStyle(){return this._urlId?5:(this._ext&469762048)>>26}set underlineStyle(t){this._ext&=-469762049,this._ext|=t<<26&469762048}get underlineColor(){return this._ext&67108863}set underlineColor(t){this._ext&=-67108864,this._ext|=t&67108863}get urlId(){return this._urlId}set urlId(t){this._urlId=t}get underlineVariantOffset(){let t=(this._ext&3758096384)>>29;return t<0?t^4294967288:t}set underlineVariantOffset(t){this._ext&=536870911,this._ext|=t<<29&3758096384}clone(){return new Mr(this._ext,this._urlId)}isEmpty(){return this.underlineStyle===0&&this._urlId===0}},we=class Pr extends Bt{constructor(){super(...arguments),this.content=0,this.fg=0,this.bg=0,this.extended=new jt,this.combinedData=""}static fromCharData(t){let i=new Pr;return i.setFromCharData(t),i}isCombined(){return this.content&2097152}getWidth(){return this.content>>22}getChars(){return this.content&2097152?this.combinedData:this.content&2097151?Ue(this.content&2097151):""}getCode(){return this.isCombined()?this.combinedData.charCodeAt(this.combinedData.length-1):this.content&2097151}setFromCharData(t){this.fg=t[0],this.bg=0;let i=!1;if(t[1].length>2)i=!0;else if(t[1].length===2){let s=t[1].charCodeAt(0);if(55296<=s&&s<=56319){let r=t[1].charCodeAt(1);56320<=r&&r<=57343?this.content=(s-55296)*1024+r-56320+65536|t[2]<<22:i=!0}else i=!0}else this.content=t[1].charCodeAt(0)|t[2]<<22;i&&(this.combinedData=t[1],this.content=2097152|t[2]<<22)}getAsCharData(){return[this.fg,this.getChars(),this.getWidth(),this.getCode()]}},Es="di$target",Li="di$dependencies",_i=new Map;ce=se("BufferService"),Tr=se("CoreMouseService"),tt=se("CoreService"),Fn=se("CharsetService"),_s=se("InstantiationService"),Ar=se("LogService"),de=se("OptionsService"),Or=se("OscLinkService"),$n=se("UnicodeService"),Rt=se("DecorationService"),Mi=class{constructor(e,t,i){this._bufferService=e,this._optionsService=t,this._oscLinkService=i}provideLinks(e,t){let i=this._bufferService.buffer.lines.get(e-1);if(!i){t(void 0);return}let s=[],r=this._optionsService.rawOptions.linkHandler,n=new we,o=i.getTrimmedLength(),a=-1,l=-1,h=!1;for(let d=0;d<o;d++)if(!(l===-1&&!i.hasContent(d))){if(i.loadCell(d,n),n.hasExtendedAttrs()&&n.extended.urlId)if(l===-1){l=d,a=n.extended.urlId;continue}else h=n.extended.urlId!==a;else l!==-1&&(h=!0);if(h||l!==-1&&d===o-1){let c=this._oscLinkService.getLinkData(a)?.uri;if(c){let u={start:{x:l+1,y:e},end:{x:d+(!h&&d===o-1?1:0),y:e}},f=!1;if(!r?.allowNonHttpProtocols)try{let _=new URL(c);["http:","https:"].includes(_.protocol)||(f=!0)}catch{f=!0}f||s.push({text:c,range:u,activate:(_,p)=>r?r.activate(_,p,u):Kn(_,p),hover:(_,p)=>r?.hover?.(_,p,u),leave:(_,p)=>r?.leave?.(_,p,u)})}h=!1,n.hasExtendedAttrs()&&n.extended.urlId?(l=d,a=n.extended.urlId):(l=-1,a=-1)}}t(s)}};Mi=q([y(0,ce),y(1,de),y(2,Or)],Mi);ni=se("CharSizeService"),Oe=se("CoreBrowserService"),us=se("MouseService"),Ie=se("RenderService"),Un=se("SelectionService"),Ir=se("CharacterJoinerService"),nt=se("ThemeService"),Nr=se("LinkProviderService"),qn=class{constructor(){this.listeners=[],this.unexpectedErrorHandler=function(e){setTimeout(()=>{throw e.stack?Ds.isErrorNoTelemetry(e)?new Ds(e.message+`

`+e.stack):new Error(e.message+`

`+e.stack):e},0)}}addListener(e){return this.listeners.push(e),()=>{this._removeListener(e)}}emit(e){this.listeners.forEach(t=>{t(e)})}_removeListener(e){this.listeners.splice(this.listeners.indexOf(e),1)}setUnexpectedErrorHandler(e){this.unexpectedErrorHandler=e}getUnexpectedErrorHandler(){return this.unexpectedErrorHandler}onUnexpectedError(e){this.unexpectedErrorHandler(e),this.emit(e)}onUnexpectedExternalError(e){this.unexpectedErrorHandler(e)}},Vn=new qn;Pi="Canceled";Xn=class extends Error{constructor(){super(Pi),this.name=this.message}};Ds=class Ti extends Error{constructor(t){super(t),this.name="CodeExpectedError"}static fromError(t){if(t instanceof Ti)return t;let i=new Ti;return i.message=t.message,i.stack=t.stack,i}static isErrorNoTelemetry(t){return t.name==="CodeExpectedError"}},Ai=class Hr extends Error{constructor(t){super(t||"An unexpected bug occurred."),Object.setPrototypeOf(this,Hr.prototype)}};Jn=class Wr{constructor(t){this._array=t,this._findLastMonotonousLastIdx=0}findLastMonotonous(t){if(Wr.assertInvariants){if(this._prevFindLastPredicate){for(let s of this._array)if(this._prevFindLastPredicate(s)&&!t(s))throw new Error("MonotonousArray: current predicate must be weaker than (or equal to) the previous predicate.")}this._prevFindLastPredicate=t}let i=Gn(this._array,t,this._findLastMonotonousLastIdx);return this._findLastMonotonousLastIdx=i+1,i===-1?void 0:this._array[i]}};Jn.assertInvariants=!1;(e=>{function t(n){return n<0}e.isLessThan=t;function i(n){return n<=0}e.isLessThanOrEqual=i;function s(n){return n>0}e.isGreaterThan=s;function r(n){return n===0}e.isNeitherLessOrGreaterThan=r,e.greaterThan=1,e.lessThan=-1,e.neitherLessOrGreaterThan=0})(zr||={});Qn=(e,t)=>e-t,Bs=class Oi{constructor(t){this.iterate=t}forEach(t){this.iterate(i=>(t(i),!0))}toArray(){let t=[];return this.iterate(i=>(t.push(i),!0)),t}filter(t){return new Oi(i=>this.iterate(s=>t(s)?i(s):!0))}map(t){return new Oi(i=>this.iterate(s=>i(t(s))))}some(t){let i=!1;return this.iterate(s=>(i=t(s),!i)),i}findFirst(t){let i;return this.iterate(s=>t(s)?(i=s,!1):!0),i}findLast(t){let i;return this.iterate(s=>(t(s)&&(i=s),!0)),i}findLastMaxBy(t){let i,s=!0;return this.iterate(r=>((s||zr.isGreaterThan(t(r,i)))&&(s=!1,i=r),!0)),i}};Bs.empty=new Bs(e=>{});ml=class{constructor(e,t){this.toKey=t,this._map=new Map,this[Rs]="SetWithKey";for(let i of e)this.add(i)}get size(){return this._map.size}add(e){let t=this.toKey(e);return this._map.set(t,e),this}delete(e){return this._map.delete(this.toKey(e))}has(e){return this._map.has(this.toKey(e))}*entries(){for(let e of this._map.values())yield[e,e]}keys(){return this.values()}*values(){for(let e of this._map.values())yield e}clear(){this._map.clear()}forEach(e,t){this._map.forEach(i=>e.call(t,i,i,this))}[(Ls=Symbol.iterator,Rs=Symbol.toStringTag,Ls)](){return this.values()}},to=class{constructor(){this.map=new Map}add(e,t){let i=this.map.get(e);i||(i=new Set,this.map.set(e,i)),i.add(t)}delete(e,t){let i=this.map.get(e);i&&(i.delete(t),i.size===0&&this.map.delete(e))}forEach(e,t){let i=this.map.get(e);i&&i.forEach(t)}get(e){return this.map.get(e)||new Set}};(e=>{function t(E){return E&&typeof E=="object"&&typeof E[Symbol.iterator]=="function"}e.is=t;let i=Object.freeze([]);function s(){return i}e.empty=s;function*r(E){yield E}e.single=r;function n(E){return t(E)?E:r(E)}e.wrap=n;function o(E){return E||i}e.from=o;function*a(E){for(let T=E.length-1;T>=0;T--)yield E[T]}e.reverse=a;function l(E){return!E||E[Symbol.iterator]().next().done===!0}e.isEmpty=l;function h(E){return E[Symbol.iterator]().next().value}e.first=h;function d(E,T){let A=0;for(let re of E)if(T(re,A++))return!0;return!1}e.some=d;function c(E,T){for(let A of E)if(T(A))return A}e.find=c;function*u(E,T){for(let A of E)T(A)&&(yield A)}e.filter=u;function*f(E,T){let A=0;for(let re of E)yield T(re,A++)}e.map=f;function*_(E,T){let A=0;for(let re of E)yield*T(re,A++)}e.flatMap=_;function*p(...E){for(let T of E)yield*T}e.concat=p;function C(E,T,A){let re=A;for(let be of E)re=T(re,be);return re}e.reduce=C;function*D(E,T,A=E.length){for(T<0&&(T+=E.length),A<0?A+=E.length:A>E.length&&(A=E.length);T<A;T++)yield E[T]}e.slice=D;function I(E,T=Number.POSITIVE_INFINITY){let A=[];if(T===0)return[A,E];let re=E[Symbol.iterator]();for(let be=0;be<T;be++){let Ce=re.next();if(Ce.done)return[A,e.empty()];A.push(Ce.value)}return[A,{[Symbol.iterator](){return re}}]}e.consume=I;async function M(E){let T=[];for await(let A of E)T.push(A);return Promise.resolve(T)}e.asyncToArray=M})(Fr||={});so=!1,Ze=null,ro=class $r{constructor(){this.livingDisposables=new Map}getDisposableData(t){let i=this.livingDisposables.get(t);return i||(i={parent:null,source:null,isSingleton:!1,value:t,idx:$r.idx++},this.livingDisposables.set(t,i)),i}trackDisposable(t){let i=this.getDisposableData(t);i.source||(i.source=new Error().stack)}setParent(t,i){let s=this.getDisposableData(t);s.parent=i}markAsDisposed(t){this.livingDisposables.delete(t)}markAsSingleton(t){this.getDisposableData(t).isSingleton=!0}getRootParent(t,i){let s=i.get(t);if(s)return s;let r=t.parent?this.getRootParent(this.getDisposableData(t.parent),i):t;return i.set(t,r),r}getTrackedDisposables(){let t=new Map;return[...this.livingDisposables.entries()].filter(([,i])=>i.source!==null&&!this.getRootParent(i,t).isSingleton).flatMap(([i])=>i)}computeLeakingDisposables(t=10,i){let s;if(i)s=i;else{let l=new Map,h=[...this.livingDisposables.values()].filter(c=>c.source!==null&&!this.getRootParent(c,l).isSingleton);if(h.length===0)return;let d=new Set(h.map(c=>c.value));if(s=h.filter(c=>!(c.parent&&d.has(c.parent))),s.length===0)throw new Error("There are cyclic diposable chains!")}if(!s)return;function r(l){function h(c,u){for(;c.length>0&&u.some(f=>typeof f=="string"?f===c[0]:c[0].match(f));)c.shift()}let d=l.source.split(`
`).map(c=>c.trim().replace("at ","")).filter(c=>c!=="");return h(d,["Error",/^trackDisposable \(.*\)$/,/^DisposableTracker.trackDisposable \(.*\)$/]),d.reverse()}let n=new to;for(let l of s){let h=r(l);for(let d=0;d<=h.length;d++)n.add(h.slice(0,d).join(`
`),l)}s.sort(Zn(l=>l.idx,Qn));let o="",a=0;for(let l of s.slice(0,t)){a++;let h=r(l),d=[];for(let c=0;c<h.length;c++){let u=h[c];u=`(shared with ${n.get(h.slice(0,c+1).join(`
`)).size}/${s.length} leaks) at ${u}`;let f=n.get(h.slice(0,c).join(`
`)),_=eo([...f].map(p=>r(p)[c]),p=>p);delete _[h[c]];for(let[p,C]of Object.entries(_))d.unshift(`    - stacktraces of ${C.length} other leaks continue with ${p}`);d.unshift(u)}o+=`
